  ...
  <?php echo csrf_field(); ?>
    <div class="row g-3 mb-3">
        <div class="col-new">
            ...
            <input id="ID" type="text" class="form-control" placeholder="Purchase" aria-label="ID" readonly>
            <!-- @AR, end -->
        </div>
    </div>
...
<div class="modal fade mb-3" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content" id="modal-sell">
            <div class="modal-header">
                ...
                <h1 class="modal-title fs-5" id="exampleModalLabel">Choose Materials</h1>
                <!-- @AR, end -->
    ...
    <div>
        ...
        <button type="button" id="create-button" class="btn btn-primary">Purchase</button>
        <!-- @AR, end -->
...
<?php echo $__env->make('layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\RYZEN\OneDrive\Documents\GitHub\TA-2\resources\views/purchase.blade.php ENDPATH**/ ?>